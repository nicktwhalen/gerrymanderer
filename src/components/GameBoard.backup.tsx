...
import { useSimpleInteraction } from '@/hooks/useSimpleInteraction';
...
export default function GameBoard() {
  ...
  const { handleMouseDown, handleMouseEnter, handleMouseUp, handleTouchStart, interactionMode } = useSimpleInteraction();
  const { showTutorial, closeTutorial, openTutorial } = useTutorial();

  // Global mouseup listener for the simple interaction system
  useEffect(() => {
